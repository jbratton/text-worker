...
ActiveRecord::Schema.define(version: 20150310205636) do
  ...
  add_index "recipients", ["organization_id"], name: "index_recipients_on_organization_id"
  add_index "recipients", ["recipient_list_id"], name: "index_recipients_on_recipient_list_id"
